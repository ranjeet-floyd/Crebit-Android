...
import in.crebit.app.WebView.IDs.insurance;
...
import in.crebit.app.WebView.requestparam.InsuranceParams;
import in.crebit.app.WebView.response.InsuranceResponse;
...
public class Insurance extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s = new SpannableString("Insurance");
