...
import in.crebit.app.WebView.IDs.gasBill;
...
import in.crebit.app.WebView.requestparam.GasBillParams;
import in.crebit.app.WebView.response.GasBillResponse;
...
public class GasBill extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s = new SpannableString("Gas Bill");
