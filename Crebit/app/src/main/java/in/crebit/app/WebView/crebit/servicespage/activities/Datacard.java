...
import in.crebit.app.WebView.IDs.dataCard;
...
import in.crebit.app.WebView.requestparam.DataCardParams;
import in.crebit.app.WebView.response.DataCardResponse;
...
public class Datacard extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s = new SpannableString("Data Card");
