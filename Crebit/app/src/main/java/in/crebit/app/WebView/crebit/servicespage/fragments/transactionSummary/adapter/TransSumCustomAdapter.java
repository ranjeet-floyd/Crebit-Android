package in.crebit.app.WebView.crebit.servicespage.fragments.transactionSummary.adapter;
...
import in.crebit.app.WebView.crebit.servicespage.fragments.transactionSummary.checkStatus.CheckStatus;
...
public class TransSumCustomAdapter extends BaseAdapter {
    ...
    public TransSumCustomAdapter(Context context, ArrayList<TransSumResult> transSumResultList) {
        if (context != null && transSumResultList != null) {
    ...
    @Override
    public int getCount() {
        if (tranSumResultArrayList != null)
